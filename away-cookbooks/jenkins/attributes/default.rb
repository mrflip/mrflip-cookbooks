...
#"Remote FS root"
if node[:os] == "windows"
  default[:jenkins][:node][:home_dir] = "C:/jenkins"
elsif node[:os] == "darwin"
  default[:jenkins][:node][:home_dir] = "/Users/jenkins"
else
  default[:jenkins][:node][:home_dir] = "/var/lib/jenkins-node"
end
